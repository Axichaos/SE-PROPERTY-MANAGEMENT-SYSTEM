...
CREATE DEFINER=`root`@`localhost` PROCEDURE `empadd` (IN `name` VARCHAR(255), IN `cont` VARCHAR(255), IN `email` VARCHAR(255), IN `piclink` VARCHAR(255), IN `jobt` VARCHAR(255), IN `dept` VARCHAR(255))  NO SQL
INSERT INTO tblemployee(tblemployee.name,tblemployee.contactno,tblemployee.email_add,tblemployee.pic_source,tblemployee.job_title,tblemployee.department) VALUES(name,cont,email,piclink,jobt,dept)$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `empedit` (IN `empid` INT, IN `name` VARCHAR(255), IN `cont` VARCHAR(255), IN `email` VARCHAR(255), IN `piclink` VARCHAR(255), IN `jobt` VARCHAR(255), IN `dept` VARCHAR(255))  NO SQL
UPDATE tblemployee SET tblemployee.name = name, tblemployee.contactno = cont, tblemployee.email_add = email, tblemployee.pic_source = piclink , tblemployee.job_title = jobt, tblemployee.department = dept WHERE tblemployee.emp_id = empid$$
...
INSERT INTO `tblemployee` (`emp_id`, `name`, `contactno`, `email_add`, `pic_source`, `job_title`, `department`) VALUES
(1, 'Axichaoss', '966488658765', 'Jibreels50@gmail.com', 'C:\\Users\\jibre\\Pictures\\53860951_1821530097951887_5658815649535754240_n.jpg', 'Property Officer', 'Supply Monitoring Unit'),
(4, 'asdasdasd', '9000', 'jibreels50@gmail.com', 'C:\\Users\\jibre\\Pictures\\Album Art\\TeamContribution.jpg', 'Professional Hair Inspector', 'Administration');
...
(201, '10/2/2019', 'asdasdasd/Sulu Harbourfront-Docking Bay', 'InvNo-90181Y', 'Accountable Officer changed at 2:17 AM', 'CHANGE', 'Past', 0),
(202, '10/2/2019', 'asdasdasd/Sulu Harbourfront-Docking Bay', 'InvNo-90182E', 'Property sent/be sent at  2:17 AM', 'SENT', 'Past', 0),
(203, '10/2/2019', 'asdasdasd/Sulu Harbourfront-Docking Bay', 'InvNo-90182E', 'Accountable Officer changed at 2:17 AM', 'CHANGE', 'Past', 0),
(204, '10/2/2019', 'asdasdasd/Sulu Harbourfront-Docking Bay', 'InvNo-90183Y', 'Property sent/be sent at  2:17 AM', 'SENT', 'Past', 0),
(205, '10/2/2019', 'asdasdasd/Sulu Harbourfront-Docking Bay', 'InvNo-90183Y', 'Accountable Officer changed at 2:17 AM', 'CHANGE', 'Past', 0),
(206, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90181Y', 'Property returned at  7:22 AM', 'RETURN', 'Past', 0),
(207, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90181Y', 'Accountable Officer changed at 7:22 AM', 'CHANGE', 'Past', 0),
(208, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90182E', 'Property returned at  7:22 AM', 'RETURN', 'Past', 0),
(209, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90182E', 'Accountable Officer changed at 7:22 AM', 'CHANGE', 'Past', 0),
(210, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90183Y', 'Property returned at  7:22 AM', 'RETURN', 'Past', 0),
(211, '10/9/2019', 'Axichaoss/DICT-BUILDING-ZC-Supply Room', 'InvNo-90183Y', 'Accountable Officer changed at 7:22 AM', 'CHANGE', 'Past', 0),
(212, '10/9/2019', 'Axichaoss/Sulu Harbourfront-Docking Bay', 'InvNo-90181Y', 'Property sent/be sent at  7:23 AM', 'SENT', 'Current', 0),
(213, '10/9/2019', 'Axichaoss/Sulu Harbourfront-Docking Bay', 'InvNo-90182E', 'Property sent/be sent at  7:23 AM', 'SENT', 'Current', 0),
(214, '10/9/2019', 'Axichaoss/Sulu Harbourfront-Docking Bay', 'InvNo-90183Y', 'Property sent/be sent at  7:23 AM', 'SENT', 'Current', 0);
...
('InvNo-90181Y', 'Acer', 'Set', 'Equipment', 'adad', 'ART-90', 1099, 'ddd', 2, 'YUN', 1, '1-06-99-990', 'UNDISPOSED', NULL, 'No', 'PAR', 'No', '10/2/2019'),
('InvNo-90182E', 'Acer', 'Set', 'Equipment', 'adad', 'ART-90', 1099, 'ddd', 2, 'JUN', 1, '1-06-99-990', 'UNDISPOSED', NULL, 'No', 'PAR', 'No', '10/2/2019'),
('InvNo-90183Y', 'Acer', 'Set', 'Furniture', 'adadasddd', 'ART-9033', 1099, 'ddd1233', 2, 'GUN123', 1, '1-06-05-070', 'UNDISPOSED', NULL, 'Yes', 'ICS', 'Yes', '10/14/2019');
